...
type RumEvent struct {
	...
	Country       string `json:"geo_country_code"`
	...
	Latency    json.Number `json:"latency,omitempty"`
	StatusCode json.Number `json:"statusCode,omitempty"`
	Up         json.Number `json:"up"`
	Cdir       string      `json:"cdir,omitempty"`
	Ans        json.Number `json:"ans,omitempty"`
}
